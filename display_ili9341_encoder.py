...
class Display:
    ...
    def __init__(self, units='F'):
        ...
        self.HEIGHT = 240
        # Init Device
        # spi set to make the display work with other spi devices like a max31865
        self.serial = spi(spi=spidev.SpiDev(), port=0, device=0, gpio_DC=16, gpio_RST=20, bus_speed_hz=32000000,
                          reset_hold_time=0.2,
        ...
        self.my_encoder = pyky040.Encoder(CLK=25, DT=24, SW=23)
